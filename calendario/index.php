                        ...
                        <div class="page-header"><h2></h2></div>
                                <div class="pull-left form-inline"><br>
                                    ...
                                    <div class="pull-right form-inline"><br>
                                        <button class="btn btn-info" data-toggle='modal' data-target='#add_evento'>Hacer Reservación</button>
                                    </div>
      ...
      <div class="modal-body">
        ...
        <input type="hidden" name="url" value="<?=$base_url?>descripcion_evento.php?id=<?=$id_evento?>">
                    ...
                    <select class="form-control" name="class" id="tipo">
                        <option value="despedida-solter">Despedida de Soltero</option>
                        <option value="velada-romantica">Velada Romántica</option>
                        <option value="viaje-estudio">Viaje de Estudio</option>
                    ...
                    <label for="title">Nombre de quien reserva</label>
